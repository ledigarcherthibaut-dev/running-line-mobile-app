...
const LEVEL_OPTIONS = [
  { value: 'beginner' as Level, icon: 'sunrise' as const, label: 'Débutant', sub: '<1 an' },
  { value: 'intermediate' as Level, icon: 'activity' as const, label: 'Inter.', sub: '1-3 ans' },
  { value: 'advanced' as Level, icon: 'zap' as const, label: 'Avancé', sub: '>3 ans' },
];
